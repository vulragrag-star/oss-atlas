...
- Scored rows: **1571** across eight sectors · proceed **1076**
...
- Synthesis: CLI/build primary; SQL/storage + DevEx secondary; hard leaves fish/sqlite/AgentScan/Zig — [`SYNTHESIS.md`](SYNTHESIS.md)
