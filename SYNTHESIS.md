...
- Scored repos (unique): **2934**
- Proceed: **2013**
- Mid-band (1k–5k★) scored: **1616** (proceed 1174)
- By sector: {'python-tooling': 353, 'security-crypto': 363, 'cli-systems': 378, 'editors-devex': 353, 'compilers-runtimes': 376, 'databases-storage': 335, 'networking-distributed': 356, 'devops-build': 420}
- Policy mix: {'silent': 2596, 'hard_ban': 36, 'disclosure': 250, 'hostility_risk': 33, 'agentscan': 19}
...
- Latest slice: **devops-build midband product deepen** (+101 scored, 69 proceed) — home-manager, krew, dockerc, flipt, cdk8s, kube-ps1, wud, kube-no-trouble, alloy, nixos-anywhere, disko, faasd, NixOS-WSL, kubespy, kro, projen, cargo-make, fir…
