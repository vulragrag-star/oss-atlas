...
4. Never reopen `forever_out` / hard_ban repos (`fish-shell/fish-shell`, `sqlite/sqlite`, AgentScan circles, `ziglang/zig`, `mrcjkb/rustaceanvim`, `jfecher/ante`, `boxlite-ai/boxlite`).
