...
- Scored repos (unique): **3045**
- Proceed: **2090**
- Mid-band (1k–5k★) scored: **1699** (proceed 1231)
- By sector: {'python-tooling': 353, 'security-crypto': 363, 'cli-systems': 378, 'editors-devex': 353, 'compilers-runtimes': 376, 'databases-storage': 446, 'networking-distributed': 356, 'devops-build': 420}
- Policy mix: {'silent': 2703, 'hard_ban': 37, 'disclosure': 253, 'hostility_risk': 33, 'agentscan': 19}
...
- Latest slice: **databases-storage midband product deepen** (+111 scored, 77 proceed) — faiss, zincsearch, annoy, gel, mycli, lancedb, bleve, usql, sea-orm, Exposed, patroni, lance, proxysql, sqldelight, pgloader, goleveldb, hnswlib, readyset, crat…
...
Databases-storage midband product deepen scored engines/KV/TSDB/vector/search/object-storage/backup/migrate/SQL-CLI/ORM leftovers (Tendis/fjall/unqlite/chai/marmot/junodb/hydradb/patroni/proxysql/pgvectorscale/VectorChord/mydumper/xtrabackup/storj/faiss/bleve/zincsearch/lancedb/sea-orm/usql/mycli/velox/readyset/gel/crate/tarantool/…). Leave cache libs/mobile ORMs/GUIs/data-grid platforms/dbt/connectors/mirrors; hard leave neilotoole/sq NO-AI. Disclosure: crate, multigres, impala.
